 ...
 */
export default function TradeTagsEditor({ tradeId, tags: tagsProp, suggestionTags = [] }) {
  ...
  return (
    <div className="trade-tags-editor">
      <div className="trade-tags-compact-bar" ref={pickerRootRef}>
        ...
        <div className="trade-tags-chips-scroller" title={tags.length ? tags.join(", ") : undefined}>
          {tags.length > 0
            ? tags.map((t) => (
                <button
                  key={t}
